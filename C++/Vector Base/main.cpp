...
//!         @mainpage
//!
//!         @author             Sergey Ivanychev, MIPT DCAM,
//!         sergeyivanychev@gmail.com
//!
//!         @par                This project is second generation template-based
//!         vector, which is able
//!                             to deal with any objects, with basic interface
//!                             and standard types of C++.
//!
//!         @brief              The project now (v 2.0) contain main.cpp file
//!         itself and
//!
//!                             --  exception.cpp / exception.h     - Files with
//!                             my exception type implemented.
//!                                                                   See
//!                                                                   description
//!                                                                   in its
//!                                                                   header
//!                             --  iv_vector.h                     - Header
//!                             with VECBASE class template and it's methods
//!                             templates
//!                             --  iv_alloc.h                      - Here's
//!                             some stuff, which is not still developed
//!                             properly. It is
//!                                                                   supposed
//!                                                                   to be
//!                                                                   special
...
/**
 *       @brief                  tmain function is a usual testing function,
 *that was used to debug VECBASE. There are two parts of code, one of it is
 *commented, that test <string> vector and <int> vector, showing that it could
 *work with both objects and standard data types.
 *
 *
 *
 *
...
int tmain() {
  ...
  //!     @brief      Here testing calling different constructors
      ...
      iv_vecbase<std::string> fourth = iv_vecbase<std::string>(first,
  (unsigned)1, (unsigned)2); iv_vecbase<std::string> fifth  =
  iv_vecbase<std::string>();
...
/**
 *       @brief              gen_th_string                   -  generates string
 *like "This string is [ARG]", where ARG is input number
 *
 *                           print_str_vec, print_int_vec    -  functions print
 *detailed dump of string and int VECBASEs
 *
 **/

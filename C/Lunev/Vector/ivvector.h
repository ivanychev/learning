 ...
 * @details If allocated memory is bigger than needed, it will be cut to current
 * size of vector
 *
 * @param  current vector
...
void *vector_iter_do(vector_iter *iter, void *args,
                     void *(*proceed)(void *obj, void *argv));

...
/*
 *		@brief				This header contains common macroses
 *and constants used by Sergey Ivanychev
 *
 ...
 *
 *              	        			Changelog v.1.02
 *              	        			--  Added *OUT macroses for fast
 *variable printing
 *						--  F_CHECK is verbose by
 *default
 *
 *						Changelog v1.03
 *						--  Added iv_standard.o library
 *declarations
 *
 */
 ...
 * 			IV_COPYSIZEFAILED 	if number of read bytes != file
 * size 0 			if success
 *
 */

...
/**
                        @par			These functions are used by tree
optimizet to calculate function values if it is possible to calculate I suppose,
it's not necessary to write docs for every function. Each of them gets number
arguments array and pointer to result. Each function returns condition of
proceeding.
**/

...
/**
                get_str					function that scans for
a string
...
/**
                is_there_string				searches for string in
string
...
found fragment, if it's found, otherwise NULL
**/

char *is_there_string(char *searched, const int size_scd, char *string,
                      const int size_str);

/**		string_size				counts the size of
string
